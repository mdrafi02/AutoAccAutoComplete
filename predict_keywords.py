...
def cli_loop(model, tokenizer):
    ...
    print("=" * 60)
    print(f"Model expects {context_size} previous keywords to predict the next keyword.")
    print("Enter comma-separated keywords (e.g., keyword1, keyword2)")
    print(f"If you provide more than {context_size}, only the last {context_size} will be used.")
